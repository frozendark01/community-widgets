...
- type: custom-api
  ...
  cache: 1d
  url: https://raw.githubusercontent.com/frozendark01/community-widgets/refs/heads/main/registry/widgets.json
  template: |
    <ul class="list list-gap-14 collapsible-container" data-collapse-after="3">
      ...
      {{ range $widgets }}
      <li>
        <a class="size-h4 block text-truncate color-primary-if-not-visited" href="https://github.com/frozendark01/community-widgets/blob/main/widgets/{{ .String "directory" }}/README.md" target="_blank" rel="noreferrer">{{ .String "title" }}</a>
